...
<head>
  ...
  <title>Superadmin Login - हरित नेपाल</title>
...
<body class="relative min-h-screen bg-gray-200 bg-cover bg-center bg-no-repeat">
  <div class="flex justify-center items-center min-h-screen px-4 bg-overlay">
    <form action="/GreenBin/backend/superAdmin/superAdminLogin.php" method="POST"
      ...
      <h2 class="text-2xl font-bold text-center mb-2">Superadmin Login</h2>
