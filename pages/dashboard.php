...
<head>
  ...
  <link href="../frontend/dashboard/dashboard.css" rel="stylesheet">
  <script>
    tailwind.config = {
      theme: {
        extend: {
...
<body class="font-inter bg-gradient-to-br from-blue-50 via-white to-green-50 min-h-screen">
  ...
  <header class="bg-white shadow-sm border-b border-gray-200 py-4 px-6 flex justify-between items-center">
    <div class="flex items-center gap-3">
      <img src="../frontend/img/mountain.png" class="w-8 h-8" alt="Logo" />
      <div>
  ...
  <main class="max-w-6xl mx-auto p-6">
    ...
    <!-- Report Form -->
    <section class="bg-white p-6 rounded-lg shadow-md max-w-3xl mx-auto mb-10">
    ...
    <section class="max-w-5xl mx-auto bg-white border rounded-lg shadow p-6">
      ...
      <div class="reports-list grid gap-4"></div>

      <div class="no-reports text-center text-gray-500 py-8 border border-dashed rounded-md">
